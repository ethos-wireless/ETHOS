...
int main(int argc, char* argv[]) {
    ...
    std::chrono::duration<uint64_t,std::milli> cpu_measure_interval = std::chrono::milliseconds(50);        // default 50ms    custom 500ms
    std::chrono::duration<uint64_t,std::milli> gpu_measure_interval = std::chrono::milliseconds(50);        // default 50ms    custom 500ms
    std::chrono::duration<uint64_t,std::milli> ru_measure_interval = std::chrono::milliseconds(10);         // default 10ms
    std::chrono::duration<uint64_t,std::milli> print_interval = std::chrono::milliseconds(50);              // default 50ms    custom 200ms
